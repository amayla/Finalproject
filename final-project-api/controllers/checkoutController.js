...
module.exports={
    getTransaction : ( req,res ) => {
        let sql = `select * from transaction join transaction_details on transaction.transaction_id = transaction_details.transaction_id where transaction.transaction_id=${req.query.transaction_id}`
